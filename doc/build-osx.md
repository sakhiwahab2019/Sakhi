# Mac OS X Sakhid Build Instructions
...
* See readme-qt.rst for instructions on building Sakhi QT, the
...
## Useful commands
    ...
    ./sakhid --help  # for a list of command-line options.
    ./sakhid -daemon # to start the sakhi daemon.
    ./sakhid help    # When the daemon is running, to get a list of RPC commands
